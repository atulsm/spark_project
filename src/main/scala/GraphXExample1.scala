...
object GraphXExample1 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val path: RDD[String] = subex_graph.triplets.map(triplet => triplet.srcAttr._1
      + " playing role of " + triplet.srcAttr._2 + " is the " + triplet.attr + "of" + triplet.dstAttr._1 + " playing role of " + triplet.dstAttr._2)
